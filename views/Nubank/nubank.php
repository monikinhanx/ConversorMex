...
<body style="<?= $bg ?>">
    <main class="d-flex justify-content-end">
        ...
        <section class="box-interno my-auto">
            ...
            <div class="container">
                <h1 class="mb-5 title">Envio de Interações</h1>            
                <p class="sub mb-3">Através desse sistema é possivel enviar as interações para a ferramenta da CallMiner</p>
                <a href="/?path" class="btn btn-mex mb-5">Upload Texto</a>
                <!-- <a href="/?" class="btn btn-mex mb-5">Upload Áudio</a> -->
            </div>
        </section>
    </main>
