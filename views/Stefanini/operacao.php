...
<body style="<?= $bg ?>">
    <main class="d-flex justify-content-end">
        ...
        <section class="box-interno my-auto">
            ...
            <div class="container">
                <h1 class="mb-5 title">Escolha a operação</h1>
                <p class="erro"><?php if(isset($_SESSION['erroOperacao'])) echo $_SESSION['erroOperacao'] ?></p>
                <form action="/?selecionaoperacao" enctype="multipart/form-data" method="post">
                    <div class="form-group">
                        <label for="operacao">Escolha a operação que deseja selecionar a amostra:</label>
                    ...
                    <button type="submit" class="btn btn-mex mb-5">Selecionar Operação</button>
                </form>
            </div>
        </section>
    </main>
